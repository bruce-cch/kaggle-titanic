...
with tf.Session( config=tf.ConfigProto(allow_soft_placement=True) ) as sess:
    ...
    saver.save(sess, "c:/pythonwork/titanic.ckpt")

plt.plot(x_collect, train_loss_collect, "r--", label= 'train')
plt.plot(x_collect, valid_loss_collect, "bx", label= 'test' )
plt.title('Loss Analysis', fontsize=20, loc='left')
plt.legend()
plt.grid()
plt.show()

plt.plot(x_collect, train_acc_collect, "r--", label= 'train')
plt.plot(x_collect, valid_acc_collect, "bx", label= 'test')
plt.title('Accuracy Analysis', fontsize=20, loc='left')
plt.legend()
plt.grid()
plt.show()
